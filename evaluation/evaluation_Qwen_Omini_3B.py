...
def func_return_scores_one(modelname=None, dataset_candidates='affectgpt'):
    ...
    for dataset in process_datasets:
        ...
        process_root = f"output/log_information/Qwen2.5-Omni/inference_result/3B/results-{dataset}/{modelname}"
        ## 计算指标
...
if __name__ == "__main__":
    ...
    for modelname in [
        ...
        # for dataset in ["mer2023"]:
            ...
            main_zeroshot_scores(f"output/log_information/Qwen2.5-Omni/inference_result/3B/results-{dataset}/{modelname}")
