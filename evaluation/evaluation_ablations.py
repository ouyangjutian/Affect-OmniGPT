...
from my_affect_omnigpt.evaluation.wheel import func_get_name2reason
from my_affect_omnigpt.datasets.builders.image_text_pair_builder import * # 加载所有dataset cls
from my_affect_omnigpt.evaluation.ew_metric import *
from my_affect_omnigpt.evaluation.wheel import *
...
def func_return_scores_one(modelname=None, dataset_candidates='affectgpt'):
    ...
    for dataset in process_datasets:
        ...
        process_root = f"output/log_information/ablations/lora/emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame_au_Nonverbal_lora8/inference_result/results-{dataset}/{modelname}"
        ## 计算指标
...
if __name__ == "__main__":
    ...
    #                 ]:
    for modelname in [
                    'emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame_au_Nonverbal_lora8',
                    ]:                    
        for dataset in ["mer2023", "mer2024", "meld", "iemocapfour", "cmumosi", "cmumosei", "sims", "simsv2", "ovmerdplus"]:
            ...
            main_zeroshot_scores(f"output/log_information/ablations/lora/emercoarse_highlevelfilter4_outputhybird_bestsetup_bestfusion_lz_face_frame_au_Nonverbal_lora8/inference_result/results-{dataset}/{modelname}")
